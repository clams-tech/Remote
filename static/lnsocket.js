var Module = (() => {
  ...
  return function (Module) {
    ...
    var _lnsocket_decrypt_header = (Module["_lnsocket_decrypt_header"] =
      function () {
        return (_lnsocket_decrypt_header = Module["_lnsocket_decrypt_header"] =
          Module["asm"]["q"]).apply(null, arguments);
      });
    var _lnsocket_make_ping_msg = (Module["_lnsocket_make_ping_msg"] =
      function () {
    ...
    var _lnsocket_print_errors = (Module["_lnsocket_print_errors"] =
      function () {
    ...
    var _commando_make_rpc_msg = (Module["_commando_make_rpc_msg"] =
      function () {
...
async function lnsocket_init() {
  ...
  LNSocket.prototype.make_default_initmsg =
    function _lnsocket_make_default_initmsg() {
      const buflen = 1024;
      let len = 0;
      const buf = module._malloc(buflen);
      module.HEAPU8.set(Uint8Array, buf);
