<script lang="ts">
  ...
  function formatAPY(apy: string) {
    return Number(apy.slice(0, -1)).toFixed(3)
  }
</script>
...
{#if net}
  <section class="mt-10 p-6">
    ...
    <div class="mt-6 max-w-md rounded-lg shadow-lg border">
      <table class="w-full">
        <thead>
        ...
        <tbody>
          <tr>
            ...
            <!-- APY -->
            <td class="px-2 py-2 border-t">{formatAPY(net.apy_in_initial)}</td>
          </tr>
          <tr>
            <td class="px-2 py-2 font-semibold uppercase border-t border-b"
            ...
            <!-- APY -->
            <td class="px-2 py-2 border-t">{formatAPY(net.apy_out_initial)}</td>
          </tr>
          <tr>
            ...
            >
            <!-- APY -->
            <td class="px-2 py-2 border-t">{formatAPY(net.apy_total_initial)}</td>
          </tr>
        </tbody>
      </table>
    </div>
